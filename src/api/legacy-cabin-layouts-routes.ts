...
import { LegacyCabinLayouts } from '../application/legacy-cabin-layouts';

export const router = express.Router();

const dal = new CabinLayoutsDAL(pool);
const app = new LegacyCabinLayouts(dal, pool)
...
router.post('/', async (req, res) => {
    try {
        let cabinLayout = req.body as LegacyCabinLayout;
...
async function isLayoutValid(layout: LegacyCabinLayout): Promise<boolean> {
